...
def bin_pix2arcmin(bin_values, pix2arcmin):
    ...
    bin_radius, bin_width, raw_cts, err_raw_cts, net_cts, err_net_cts, 
        bkg_cts, err_bkg_cts, raw_rate, err_raw_rate, \
    ...
    if bkg_rate > 0:
        ...
        t_bkg = 0.
    return (bin_radius, bin_width, raw_cts, err_raw_cts, net_cts, err_net_cts, 
            bkg_cts, err_bkg_cts, raw_rate, err_raw_rate, net_rate, err_net_rate, 
